...
Este depurador gráfico open source permite el uso de breakpoints, inspección de registros, ver y modificar memoria, trazar instrucciones y analizar llamadas al sistema o librerías externas además del uso de gran variedad de plugins.
